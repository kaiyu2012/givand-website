      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="section-subtitle max-w-2xl mx-auto">
            Ready to start your project? Contact us today for a quote or to discuss your building materials needs.
          </p>
        </motion.div>
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Ningbo Givand Import and Export Co., Ltd.</p>
                  </div>
                </div>
            ...
            <div className="bg-primary-50 p-6 rounded-xl border border-primary-200">
              ...
              <div className="flex flex-wrap gap-2">
                {['Building Materials', 'Wholesale', 'Bulk Purchase', 'China Sourcing', 'Import Export', 'Logistics', 'Shipment', 'Construction Supplies'].map((keyword) => (
                  <span key={keyword} className="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-primary-200">
                    {keyword}
                  </span>
                ))}
              </div>
